# PhysioConnect — Humanization Prompt
...
**Keep uppercase:** Section headers on pages, badge text, table column headers, button labels, the product name `PHYSIOCONNECT`, section number prefixes like `01.`.
...
# PhysioConnect — Complete Design Transformation Prompt
...
Text:          #0B4F6C  (primary)
Font:          Inter 700, 16px
Case:          PHYSIOCONNECT stays uppercase — this is a brand identifier
```
