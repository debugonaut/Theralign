          ...
          {steps.map((step, index) => (
            <div key={index} className="bg-white border-2 border-neutral-900 p-8 relative z-10 flex flex-col h-full">
              <div className="flex items-center gap-4 mb-6">
                <span className="text-[48px] font-semibold tracking-[-0.04em] text-neutral-900 font-swiss leading-none">
                  {step.number}
                </span>
                <h3 className="font-medium text-[16px] text-neutral-900 uppercase tracking-widest leading-snug">
                  {step.title}
                </h3>
              </div>
