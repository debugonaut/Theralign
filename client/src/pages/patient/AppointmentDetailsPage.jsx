    ...
    return (
      <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-6">
        <Card className="max-w-[480px] w-full p-6 text-center rounded-[12px] shadow-level-1">
          ...
          <h2 className="text-display-xs font-medium text-neutral-900 tracking-tight">Appointment Not Found</h2>
    ...
    <div className="min-h-screen bg-neutral-50 py-6 px-6">
      <div className="max-w-[560px] mx-auto flex flex-col gap-6">
        ...
        <Link 
          ...
          className="inline-flex items-center gap-1 text-ui-sm font-medium text-neutral-500 hover:text-neutral-900 transition-colors self-start"
        >
          <ChevronLeft size={16} />
        ...
        <div className="text-center mb-2">
          <h1 className="text-[28px] font-medium text-neutral-900 tracking-tight font-swiss">Appointment Details</h1>
          <p className="text-neutral-500 mt-1 text-ui-sm font-medium uppercase tracking-wider">
        ...
        <Card className="p-6 sm:p-6 rounded-[12px] shadow-level-1 bg-white border border-neutral-200">
          ...
          <div className="py-6 border-b border-neutral-100 flex flex-col gap-4 text-left">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <span className="text-ui-md font-medium text-neutral-900">Consultation Fee</span>
              </div>
              <span className="text-ui-lg font-semibold text-neutral-900">
          ...
          {appointment.sessionDocument?.url && (
            <div className="py-6 border-b border-neutral-100 text-left flex flex-col gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-ui-md font-medium text-success">Clinical Documents Attached</span>
              </div>
          ...
          {appointment.status === 'cancelled' && (
            <div className="p-4 mt-6 bg-[#C0392B]/5 border border-danger/20 rounded-md text-left">
              <span className="text-sm font-semibold text-danger uppercase tracking-widest block mb-1">
                Cancellation Details
              </span>
              <p className="text-ui-sm text-neutral-700 font-normal leading-relaxed">
