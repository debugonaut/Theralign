    ...
    const fetchProfile = async () => {
      ...
      try {
        ...
        if (res.success && res.data) {
          ...
          // Lazy non-blocking AI summary fetch
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm text-left">
            ...
            <p className="text-sm text-slate-600 leading-relaxed whitespace-pre-line font-medium mb-2">
              {profile.bio}
            </p>

            {/* AI Summary Section */}
            {summaryLoading && (
              <div className="mt-4 p-4 bg-slate-50 border border-slate-200/50 rounded-2xl animate-pulse flex flex-col gap-2">
            ...
            {!summaryLoading && aiSummary && (
              <div className="mt-6 p-5 bg-gradient-to-br from-blue-50/50 via-indigo-50/20 to-blue-50/50 border border-blue-100/50 rounded-2xl">
                ...
                <p className="text-[9px] text-slate-400 mt-2 font-medium">
                  Generated by AI based on verified profile qualifications and clinic metrics.
                </p>
              </div>
            )}
          </div>
