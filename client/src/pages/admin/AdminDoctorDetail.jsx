    ...
    <div className="max-w-page mx-auto py-6 select-none text-neutral-900 bg-white">
      ...
      <div className="mb-8 text-left">
        <button
          ...
          className="inline-flex items-center gap-2 text-ui-sm font-semibold text-neutral-500 hover:text-neutral-900 uppercase tracking-widest cursor-pointer select-none bg-transparent border-0"
        >
          <ArrowLeft size={14} />
        ...
        <div className="lg:col-span-7 flex flex-col gap-5 text-left pr-4">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-3">
              <h1 className="text-display-sm font-medium text-neutral-900 uppercase tracking-tighter leading-none">
                Dr. {docName}
              </h1>
              <Badge variant={badgeVariant} size="sm" />
            </div>
            <span className="text-ui-sm font-semibold text-accent tracking-widest uppercase block">
              {specText}
            </span>
          ...
          <div className="flex items-center gap-4 mt-2">
            <div className="flex items-center gap-3">
              ...
              <span className="text-ui-sm font-medium text-neutral-700 uppercase tracking-wider">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border border-neutral-900 p-4 bg-neutral-50">
              <div>
                <span className="text-sm text-neutral-500 font-medium uppercase tracking-wider">TOTAL INTAKE</span>
                <span className="text-lg font-semibold text-neutral-900 block swiss-numeric mt-1">₹{(profile.totalEarnings || 0).toLocaleString('en-IN')}</span>
              </div>
              <div>
                <span className="text-sm text-neutral-500 font-medium uppercase tracking-wider">PLATFORM COMMISSION (10%)</span>
                <span className="text-lg font-semibold text-success block swiss-numeric mt-1">₹{Math.round((profile.totalEarnings || 0) * 0.1).toLocaleString('en-IN')}</span>
              </div>
              <div>
                <span className="text-sm text-neutral-500 font-medium uppercase tracking-wider">DOCTOR NET SHARE (90%)</span>
                <span className="text-lg font-semibold text-neutral-900 block swiss-numeric mt-1">₹{Math.round((profile.totalEarnings || 0) * 0.9).toLocaleString('en-IN')}</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            {reviews.length === 0 ? (
              <div className="border border-dashed p-6 text-center text-neutral-500 text-sm font-medium uppercase tracking-widest">
                NO REVIEWS FILED
              </div>
            ) : (
              <div className="space-y-4">
                {reviews.map((rev) => (
                  ...
                  >
                    <div className="absolute top-6 right-6 w-8 h-8 border-2 border-neutral-900 flex items-center justify-center text-sm font-semibold text-neutral-900 bg-white rounded-none">
                      {rev.rating}
                    </div>
                    <span className="text-display-xs text-accent font-semibold block leading-none mb-1 select-none">“</span>
        ...
        <div className="lg:col-span-5 lg:sticky lg:top-24 border-t-2 border-neutral-900 lg:border-t-0 lg:border-l-2 lg:border-neutral-900 lg:pl-8 pt-6 lg:pt-0 z-10 flex flex-col gap-6 text-left">
          <div className="border-2 border-neutral-900 p-6 bg-neutral-50 flex flex-col gap-6">
            <div>
              ...
              <h3 className="text-ui-md font-medium text-neutral-900 uppercase tracking-tight">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                className="w-full text-center py-3 bg-white border-2 border-success text-ui-sm font-semibold uppercase tracking-widest text-success hover:bg-success hover:text-white transition-all disabled:opacity-40 select-none cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full text-center py-3 bg-white border-2 border-accent text-ui-sm font-semibold uppercase tracking-widest text-accent hover:bg-accent hover:text-white transition-all disabled:opacity-40 select-none cursor-pointer"
              >
              ...
              <button
                ...
                disabled={actionLoading}
                className="w-full text-center py-3 bg-white border-2 border-neutral-900 text-ui-sm font-semibold uppercase tracking-widest text-neutral-900 hover:bg-neutral-900 hover:text-white transition-all disabled:opacity-40 select-none cursor-pointer"
              >
                SEND NOTIFICATION →
              </button>
            </div>
            
            <div className="text-sm text-neutral-500 font-medium uppercase tracking-wider leading-relaxed">
